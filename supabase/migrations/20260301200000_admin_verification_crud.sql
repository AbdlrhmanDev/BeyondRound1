-- ============================================================
-- Admin Verification CRUD
-- 1. Admin storage policy for licenses bucket
-- 2. admin_delete_verification_request RPC
-- 3. admin_create_verification_request RPC
-- ============================================================

-- 1. Allow admins to read license files (required for signed URL generation)
CREATE POLICY "Admins can view all licenses"
  ON storage.objects FOR SELECT
  USING (bucket_id = 'licenses' AND public.has_role(auth.uid(), 'admin'));

-- 2. Delete a verification request
...
-- 3. Manually create / reset a verification request
