            ...
            <nav className="flex flex-col gap-0.5">
              ...
              <div className="flex flex-col gap-2 pt-3 mt-2 border-t border-white/10">
                <Link
                  href={`/${locale}/auth`}
                  onClick={() => setIsMenuOpen(false)}
                  className="flex w-full min-h-[44px] items-center justify-center rounded-2xl text-white/70 hover:text-white hover:bg-white/10 transition-colors"
                >
                  {logInLabel}
                </Link>
                <Link
                  href={`/${locale}/onboarding`}
                  onClick={() => setIsMenuOpen(false)}
                  className="flex w-full min-h-[44px] items-center justify-center rounded-2xl font-medium bg-gradient-gold text-primary-foreground hover:opacity-90 transition-opacity"
                >
                  {joinNowLabel}
                </Link>
              </div>
