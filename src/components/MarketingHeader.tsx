...
/**
 * Lightweight header for marketing pages - no Supabase/Auth.
 * Reduces JS bundle and main-thread work on homepage and marketing routes.
 */
...
const LanguageSwitcher = dynamic(() => import('@/components/LanguageSwitcher'), {
  ssr: false,
  loading: () => <div className="w-16 h-8 rounded-lg bg-primary-foreground/10 animate-pulse" />,
});
